 ...
 * on 2016-05-12 at 06:21:52 UTC 
 * Modify at your own risk.
 */

package com.example.vic.myapplication.jokegcm.jokeApi;
...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends JokeApiRequest<com.example.vic.myapplication.jokegcm.jokeApi.model.Joke> {
     ...
     */
    protected GetJoke() {
      super(JokeApi.this, "GET", REST_PATH, null, com.example.vic.myapplication.jokegcm.jokeApi.model.Joke.class);
    }
   ...
   *
   * @param content the {@link com.example.vic.myapplication.jokegcm.jokeApi.model.Joke}
   * @return the request
   */
  public InsertJoke insertJoke(com.example.vic.myapplication.jokegcm.jokeApi.model.Joke content) throws java.io.IOException {
    InsertJoke result = new InsertJoke(content);
    initialize(result);
    return result;
  }

  public class InsertJoke extends JokeApiRequest<com.example.vic.myapplication.jokegcm.jokeApi.model.Joke> {
     ...
     * @since 1.13
     */
    protected InsertJoke(com.example.vic.myapplication.jokegcm.jokeApi.model.Joke content) {
      super(JokeApi.this, "POST", REST_PATH, content, com.example.vic.myapplication.jokegcm.jokeApi.model.Joke.class);
    }
